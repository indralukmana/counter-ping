...
export type DecrementInput<TAccountPing extends string = string> = {
...
>(
  input: DecrementInput<TAccountPing>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountPing> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as DecrementInstruction<TProgramAddress, TAccountPing>);
}
